...
<?php 
	...
	$equal="Select * from materiales where Descripcion='".$descripcion."' and IdMaterial!=".$material."  ";
	//echo $equal;
...
<table width="845" align="center" border="0">
  <tr>
    <td class="Subtitulo">YA EXISTE UN MATERIAL CON ESA DESCRIPCIÓN </td>
  </tr>
</table>
...
when 1 then 'ACTIVO'
end Estate FROM materiales where IdMaterial!=".$material." and (".$like.");";
...
?>
			...
			<table width="845" align="center" border="0">
			 ...
			 <table width="333" border="0" align="center">
			  ...
			  <tr>
				<td width="81" class="EncabezadoTabla">DESCRIPCI&Oacute;N</td>
				<td width="82" class="EncabezadoTabla">FdA</td>
				<td width="158" class="EncabezadoTabla">ESTATUS</td>
			   </tr>
			  ...
			  <td align="center"><?php echo $fda; ?></td>
...
<tr>
				  <td><input name="Submit2" type="button" class="boton" onclick="history.go(-1)" value="Regresar" /></td>
			...
			<?php } else {?>
							...
							<table width="845" align="center" border="0">
							 ...
							 <table width="333" border="0" align="center">
							  ...
							  <tr>
								<td width="101" class="EncabezadoTabla">DESCRIPCI&Oacute;N</td>
								<td width="110"  class="EncabezadoTabla">FdA</td>
								<td width="110"  class="EncabezadoTabla">ESTATUS</td>
							   </tr>
