...
if($estatus!=0)
{
	$equal="Select * from origenes where Descripcion='".$descripcion."' and IdOrigen!=".$origen."";
	//echo $equal;
...
<table width="845" align="center" border="0">
  <tr>
    <td class="Subtitulo">YA EXISTE UN ORIGEN CON ESA DESCRIPCIÓN, POR FAVOR MODIFIQUELA </td>
  </tr>
</table>
...
when 1 then 'ACTIVO'
end Estate from origenes where IdOrigen!=$origen and (".$like.")";
//echo $lik;
...
?>
			...
			<table width="845" align="center" border="0">
              <tr>
                <td class="Subtitulo">VERIFIQUE QUE EL ORIGEN QUE DESEA MODIFICAR NO HAYA SIDO REGISTRADO CON ANTERIORIDAD </td>
              </tr>
            </table>
			<table width="600" border="0" align="center">
              <tr>
              ...
              <tr class="<?php $a=$pr%2; if($a==0){ ?> Item2 <?php } else {?> Item1 <?php } ?>">
                <td width="73" align="center"><?php echo $row[Clave].$row[IdOrigen];?></td>
                <td><?PHP regresa(tiposorigenes,Descripcion,IdTipoOrigen,$row[IdTipoOrigen]); ?></td>
			...
			<table width="845" align="center" border="0">
			  <tr>
				<td class="Subtitulo">SI EL ORIGEN QUE DESEA MODIFICAR NO COINCIDE CON ALGUNO DE LOS ANTERIORES, VERIFIQUE QUE LA INFORMACI&Oacute;N A REGISTRAR SEA CORRECTA </td>
			  </tr>
			</table>
...
if($estatus==0)
{
		$hijosq="Select *, case Estatus when 0 then 'INACTIVO' when 1 then 'ACTIVO' end Estate from rutas where IdOrigen=".$origen." and IdProyecto=".$IdProyecto." and Estatus=1";
		...
		if($hijos>0)
			...
			?>
				<table width="845" align="center" border="0">
                  <tr>
                    <td class="Subtitulo">EL ORIGEN QUE DESEA DESACTIVAR, TIENE LAS SIGUIENTES RUTAS ASOCIADAS </td>
                  </tr>
                </table>
				<table width="600" border="0" align="center">
                  <tr>
                ...
                <table width="600" align="center">
                  <tr>
                    ...
                    <form action="4Modifica.php" method="post" name="frm" id="frm">
                      <td width="181" align="right"><input type="hidden" name="tipo" value="<?php echo $tipo; ?>" />
                      <input type="hidden" name="origen" value="<?php echo $origen; ?>" />
                          <input type="hidden" name="estatus" value="<?php echo $estatus; ?>" />
                          <input type="hidden" name="descripcion" value="<?php echo $descripcion; ?>" />
...
<table width="845" align="center" border="0">
 ...
 <table width="600" border="0" align="center">
  ...
  <tr>
    ...
    <td class="EncabezadoTabla">TIPO</td>
    <td class="EncabezadoTabla">DESCRIPCI&Oacute;N</td>
    <td width="72" colspan="2" class="EncabezadoTabla">ESTATUS</td>
   </tr>
...
$lik="select *, case Estatus when 0 then 'INACTIVO'
when 1 then 'ACTIVO'
end Estate from origenes where IdTiro!=$origen and (".$like.")";
//echo $lik;
$result=$link->consultar($lik);
$li=$link->affected();
...
?>
			...
			<table width="600" border="0" align="center">
              ...
              <tr class="<?php $a=$pr%2; if($a==0){ ?> Item2 <?php } else {?> Item1 <?php } ?>">
                ...
                <td><?PHP regresa(tiposorigenes,Descripcion,IdTipoOrigen,$row[IdTipo]); ?></td>
                <td><?php echo $row[Descripcion];?></td>
                <td colspan="2" align="center"><?php echo $row[Estate]; ?></td>
              </tr>
			    <?php $pr++;}?>
