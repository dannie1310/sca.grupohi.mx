...
$sqla="Lock Tables maquinaria_arrendadores Write;";
$link->consultar($sqla);
$sql="insert into maquinaria_arrendadores(Descripcion,NombreCorto) values('$descripcion', '$corto') ";
$link->consultar($sql);
$exito=$link->affected();
$sqlc="Unlock tables;";
$link->consultar($sqlc);
...
<table width="600" border="0" align="center">
  <tr>
    <td class="Subtitulo">EL ARRENDADOR HA SIDO REGISTRADO EXITOSAMENTE </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="600" border="0" align="center">
  <tr>
    <td class="Subtitulo">HUBO UN ERROR AL REGISTRAR EL ARRENDADOR, INTENTELO NUEVAMENTE </td>
  </tr>
</table>
<?php }?>
</body>
