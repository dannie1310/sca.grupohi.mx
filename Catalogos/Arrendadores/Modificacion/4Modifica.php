...
<?php 
	...
	$sql="update maquinaria_arrendadores set  Descripcion='".$descripcion."', NombreCorto='".$corto."', Estatus=".$estatus." where IdArrendador=".$sindicato." ; ";
...
<table width="845" align="center" border="0">
  <tr>
    <td class="Subtitulo">EL ARRENDADOR FUE MODIFICADO EXITOSAMENTE </td>
  </tr>
</table>
...
<tr>
  <form action="1Inicio.php" method="post"> <td width="533" align="right">&nbsp;</td>
    <td width="177" align="right"><input name="Submit" type="submit" class="boton" value="Modificar Otros Arrendadores" /></td>
</form></tr></table>
<?php } else {?>
<table width="845" align="center" border="0">
  <tr>
    <td class="Subtitulo">EL ARRENDADOR NO PUDO SER MODIFICADO, INTENTELO NUEVAMENTE</td>
  </tr>
</table>
<?php } ?>
</body>
