...
<table align="center" width="700" border="0">
  <tr>
    <td width="700" class="EncabezadoPagina"><img src="../../../Imgs/16-Sindicatos.gif" width="16" height="16" />&nbsp;SCA.- Edici&oacute;n de Arrendadores </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="680" border="0" align="center">
  ...
  <?php
  $sql="select IdArrendador,Descripcion,NombreCorto,case Estatus
  ...
  while($row=mysql_fetch_array($result))
  {
   ...
   ?>
	...
	<td width="25" align="center">
      <?php echo $row[IdArrendador];   ?></td>
    <td width="28"><input name="radiobutton" type="radio" value="radiobutton" onClick="document.frm.sindicato.value=<?php echo $row[IdArrendador]; ?>;valida();"></td>
