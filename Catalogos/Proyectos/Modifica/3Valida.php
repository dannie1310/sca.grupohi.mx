...
<?php 
	...
	$equal="Select * from proyectos where (Descripcion='".$descripcion."' or NombreCorto='".$corto."') and IdProyecto!=".$proyecto."";
	//echo $equal;
...
<table width="845" align="center" border="0">
  <tr>
    <td class="Subtitulo">YA EXISTE UN PROYECTO CON ESA DESCRIPCIÓN Y/O NOMBRE CORTO</td>
  </tr>
</table>
 ...
 <table width="600" border="0" align="center">
  ...
  $Estatus="ACTIVO";
   ?>
    <tr class="Item1">
  <td width="35" align="center"><?php echo $proyecto;   ?></td>
...
when 1 then 'ACTIVO'
end Estate FROM proyectos where IdProyecto!=$proyecto and (".$like.");";
...
?>
			...
			<table width="845" align="center" border="0">
              <tr>
                <td class="Subtitulo">VERIFIQUE QUE EL PROYECTO QUE DESEA REGISTRAR NO HAYA SIDO REGISTRADO CON ANTERIORIDAD </td>
              </tr>
            </table>
			<table width="600" border="0" align="center">
              <tr>
              ...
              <tr class="<?php $a=$pr%2; if($a==0){ ?> Item2 <?php } else {?> Item1 <?php } ?>">
                <td width="38" align="center"><?php echo $row[IdProyecto];?></td>
			...
			<table width="845" align="center" border="0">
			  <tr>
				<td class="Subtitulo">SI EL PROYECTO QUE DESEA REGISTRAR NO COINCIDE CON ALGUNO DE LOS ANTERIORES, VERIFIQUE QUE LA INFORMACI&Oacute;N A REGISTRAR SEA CORRECTA </td>
			  </tr>
			</table>
			 ...
			 <table width="600" border="0" align="center">
			  ...
			  $Estatus="ACTIVO";
			   ?>
				<tr class="Item1">
			  <td width="41" align="center"><?php echo $proyecto; ?></td>
				<td><?php echo $descripcion; ?></td>
				<td><?php echo $corto; ?></td>
				<td colspan="2" align="center"><?php echo $Estatus; ?></td>
			   </tr>
							...
							<table width="845" align="center" border="0">
							 ...
							 <table width="600" border="0" align="center">
							  ...
							  $Estatus="ACTIVO";
							   ?>
								<tr class="Item1">
							  <td width="32" align="center"><?php echo $proyecto;   ?></td>
								<td><?php echo $descripcion; ?></td>
								<td><?php echo $corto; ?></td>
								<td colspan="2" align="center"><?php echo $Estatus; ?></td>
							   </tr>
