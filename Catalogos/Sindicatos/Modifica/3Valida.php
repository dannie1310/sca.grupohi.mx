...
<?php 
	...
	$equal="Select * from sindicatos where (Descripcion='".$descripcion."' or NombreCorto='".$corto."') and IdSindicato!=".$sindicato."";
	//echo $equal;
...
<table width="845" align="center" border="0">
  <tr>
    <td class="Subtitulo">YA EXISTE UN SINDICATO CON ESA DESCRIPCIÓN Y/O NOMBRE CORTO</td>
  </tr>
</table>
...
when 1 then 'ACTIVO'
end Estate FROM sindicatos where IdSindicato!=$sindicato and (".$like.");";
...
?>
			...
			<table width="845" align="center" border="0">
              <tr>
                <td class="Subtitulo">VERIFIQUE QUE EL SINDICATO QUE DESEA REGISTRAR NO HAYA SIDO REGISTRADO CON ANTERIORIDAD </td>
              </tr>
            </table>
			<table width="600" border="0" align="center">
              <tr>
              ...
              <tr class="<?php $a=$pr%2; if($a==0){ ?> Item2 <?php } else {?> Item1 <?php } ?>">
                <td width="38" align="center"><?php echo $row[IdSindicato];?></td>
