...
<table align="center" width="700" border="0">
  <tr>
    <td width="700" class="EncabezadoPagina"><img src="../../../Imgs/16-Sindicatos.gif" width="16" height="16" />&nbsp;SCA.- Edici&oacute;n de Sindicatos </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="680" border="0" align="center">
  ...
  <?php
  $sql="select IdSindicato,Descripcion,NombreCorto,case Estatus
  when 0 then 'INACTIVO'
  when 1 then 'ACTIVO'
  end Estate FROM sindicatos ;";
	//echo $sql;
	$pr=1;
  $result=$link->consultar($sql);
  while($row=mysql_fetch_array($result))
  {
   ...
   ?>
	...
	<td width="25" align="center">
      <?php echo $row[IdSindicato];   ?></td>
    <td width="28"><input name="radiobutton" type="radio" value="radiobutton" onClick="document.frm.sindicato.value=<?php echo $row[IdSindicato]; ?>;valida();"></td>
...
<td width="773"><div align="right">
  <input type="hidden" name="sindicato">
