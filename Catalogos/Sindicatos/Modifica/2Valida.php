...
function valida()
{
	...
	{
		alert("INDIQUE LA DESCRIPCIÓN DEL SINDICATO");
	...
	{
		alert("INDIQUE EL NOMBRE CORTO DEL SINDICATO");
...
<table width="845" align="center" border="0">
  <tr >
    <td class="Subtitulo">DATOS DEL SINDICATO SELECCIONADO </td>
  </tr>
</table>
...
<table width="580" border="0" align="center">
  ...
  <?php
 $sql="SELECT * FROM sindicatos where IdSindicato=".$sindicato." ;";
 ...
 $row=mysql_fetch_array($result);
   ...
   ?>
  <tr>
    <td colspan="2"> <div align="center" class="texto"><?php echo $row[IdSindicato];   ?></div></td>
