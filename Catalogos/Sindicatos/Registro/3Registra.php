...
<table align="center" width="600" border="0">
  <tr>
    <td width="595" class="EncabezadoPagina"><img src="../../../Imgs/16-Sindicatos.gif" width="16" height="16" />&nbsp;SCA.- Registro de Sindicatos </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
$sqla="Lock Tables sindicatos Write;";
$link->consultar($sqla);
$sql="insert into sindicatos(Descripcion,NombreCorto) values('$descripcion', '$corto') ";
$link->consultar($sql);
$exito=$link->affected();
$sqlc="Unlock tables;";
$link->consultar($sqlc);
...
<table width="600" border="0" align="center">
  <tr>
    <td class="Subtitulo">EL SINDICATO HA SIDO REGISTRADO EXITOSAMENTE </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="600" border="0" align="center">
  <tr>
    <td class="Subtitulo">HUBO UN ERROR AL REGISTRAR EL SINDICATO, INTENTELO NUEVAMENTE </td>
  </tr>
</table>
<?php }?>
</body>
