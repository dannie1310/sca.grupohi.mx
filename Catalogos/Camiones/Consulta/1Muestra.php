...
<link href="../../../Clases/Styles/PaginaGeneral.css" rel="stylesheet" type="text/css" /></head>
...
<table width="845" border="0" align="center">
  <tr>
    <td colspan="6" class="Subtitulo">CAMIONES REGISTRADOS </td>
  </tr>
<script>
function manda(id)
{
	/*if (!document.getElementById) return false;
		...
		formulario.submit();*/
		this.location.href='../consulta.php?camion='+id;
}
</script>
  <tr>
    <td>&nbsp;</td>
...
if($v[Estatus]==0)
  ...
  if($v[Estatus]==1)
  $Estatus="ACTIVO";
?> <form name="frm" action="2Detalles.php" id="<?php echo $v[IdCamion]; ?>" method="post"> 
  ...
  <td valign="bottom" style="cursor:hand" onclick="manda(<?php echo $v[IdCamion]; ?>)">
    ...
    <td><table width="98">
		  <tr>
			  <td width="72" valign="bottom">
		  	<div align="right"><?php echo $v[CubicacionParaPago]; ?>			  </div></td>
			  <td width="14">m<sup>3</sup>			  </td>
		  </tr>
		 </table></td>
    <td valign="bottom">
