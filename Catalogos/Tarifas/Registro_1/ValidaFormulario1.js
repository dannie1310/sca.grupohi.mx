...
function valida(form,msg)
{
	...
	{
		if(document.getElementById(form)[i].style.display!='none'&&document.getElementById(form)[i].type!="button"&&document.getElementById(form)[i].type!="submit"&&document.getElementById(form)[i].type!="reset"&&document.getElementById(form)[i].type!="hidden"&&document.getElementById(form)[i].id!="tka")
		{
			if((document.getElementById(form)[i].value==''||parseFloat(document.getElementById(form)[i].value)==0||document.getElementById(form)[i].value=='A99'))
			{
				invalidos++;
