...
<?php
	...
	//Obtenemos los datos del Archivo a Procesar
		...
		$TamanoArchivo=$_FILES["archivo"]["size"];				//Obtenemos el Tamaño del Archivo
		$Extension=explode(".",$_FILES["archivo"]["name"]);		//Obtenemos la Extension
		$TipoExtension=count($extension)-1;								//Guardamos la Extensión del Archivo en una Variable

	//Verificamos que la extension del Archivo sea Valida
