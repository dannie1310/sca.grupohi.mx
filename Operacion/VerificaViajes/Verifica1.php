...
<input name="idviaje<?php echo $i_general; ?>" id="idviaje<?php echo $i_general; ?>" type="hidden" value="<?php echo $v_viajes["IdViaje"]; ?>" />
        ...
        Arreglo_<?php echo $i_padre ?>.push('<?php echo $i_general; ?>');
                ...
                <td align="center"><span class="detalle"><div id="dis<?php echo $i_general; ?>">
 				...
 				<td align="center" class="detalle"><div id="dpk<?php echo $i_general; ?>"> <?php echo $v_viajes["tarifa_material_pk"] ?></div></td>
 			    <td align="center" class="detalle"><div id="dks<?php echo $i_general; ?>"> <?php echo $v_viajes["tarifa_material_ks"] ?></div></td>
                <td align="center" class="detalle"><div id="dka<?php echo $i_general; ?>"> <?php echo $v_viajes["tarifa_material_ka"] ?></div></td>
                <td align="center"><span class="detalle"><div id="imp<?php echo $i_general; ?>"><?php echo $v_viajes["ImporteTotal_M"] ?>
