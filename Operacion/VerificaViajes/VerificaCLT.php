...
<input name="idviaje<?php echo $i_general; ?>" id="idviaje<?php echo $i_general; ?>" type="hidden" value="<?php echo $v_viajes["IdViaje"]; ?>" />
             <tr>
                ...
                <td><div id="imagen<?php echo $i_general; ?>"><img src="../../Imagenes/<?php if($v_viajes["idruta"]==''||$v_viajes["tarifa_ruta"]==''||$v_viajes["Estatus"]==10||($v_viajes["Estatus"]==0&&($v_viajes["tiempo"]==0||($v_viajes["tiempo"]<$v_viajes["cronometria"])))) echo "bred"; else echo "bgreen"; ?>.gif" <?php
				...
				if($v_viajes["tiempo"]!=0&&$v_viajes["Estatus"]==0&&(($v_viajes["tiempo"]<$v_viajes["cronometria"]))) {echo "title='El viaje no puede ser registrado porque no cumple con los tiempos de cronometr&iacute;a de la ruta'";} 
				else
                ...
                <td align="center"><div id="ch<?php echo $i_general ?>">
                  ...
                  onclick="clic('r<?php echo $i_general; ?>')" <?php if($v_viajes["idruta"]==''||$v_viajes["tarifa_ruta"]==''||$v_viajes["Estatus"]==10||($v_viajes["Estatus"]==0&&($v_viajes["tiempo"]==0||($v_viajes["tiempo"]<$v_viajes["cronometria"])))) echo "disabled"; else echo "checked"; ?> style="cursor:pointer"/>
               </div></td>
                <td align="center"><div id="nch<?php echo $i_general ?>">
                  <input type="checkbox" name="r<?php echo $i_general; ?>" id="r<?php echo $i_general; ?>"  <?php if($v_viajes["idruta"]==''||$v_viajes["tarifa_ruta"]==''||$v_viajes["Estatus"]==10||($v_viajes["Estatus"]==0&&($v_viajes["tiempo"]==0||($v_viajes["tiempo"]<$v_viajes["cronometria"])))){ echo "checked"; }?> onclick="clic('a<?php echo $i_general; ?>')" style="cursor:pointer"/>
                </div></td>
        ...
        Arreglo_<?php echo $i_padre ?>.push('<?php echo $i_general; ?>');
 		...
 		<td align="center" class="detalle"><div id="dpk<?php echo $i_general; ?>"> <?php echo $v_viajes["tarifa_ruta_pk"] ?></div></td>
              ...
              <?php $i_general++; $i++;}?>
                     ...
                     <tr>
                  <td colspan="20" align="right"><input name="button" type="submit" class="boton" id="button" value="Registrar Viajes" onclick="prepara_registra_viajes(Arreglo_Procesar_<?php echo $i_padre ?>)"/></td>
                  </tr>           </table></td>
          </tr>
          <?php $i_padre++; } ?>
        </table></td>
...
for(o=0;o<arreglo.length;o++)
	{
		...
		try{accion=(document.getElementById('a'+arreglo[o]).checked)?1:(document.getElementById('r'+arreglo[o]).checked)?0:'n';
