...
<body >
<div id="layout">
<div id="encabezado_pagina" style="width:100%;"><img src="../../Imagenes/aprobacion.gif" width="47" height="46" />Validaci�n de Viajes</div>
          ...
          <tr style="display:none" id="<?php echo $v["FechaO"].$v_tiros["IdTiro"].$v_camiones["Camion"]?>">
            <td><table border="0" cellpadding="2" cellspacing="0" class="formulario"  style="width:auto">
              ...
              <tr class="Item">
                ...
                <td rowspan="2" align="center">Cubicaci&oacute;n</td>
                ...
                <td rowspan="2" align="center">Distancia</td>
...
<input name="idviaje<?php echo $i_general; ?>" id="idviaje<?php echo $i_general; ?>" type="hidden" value="<?php echo $v_viajes["IdViaje"]; ?>" />
             <tr>
				...
				else if($v_viajes["tarifa_ruta"]==''&&$v_viajes["idruta"]!='') echo "title='El viaje no puede ser registrado porque no hay una tarifa registrada para su ruta'";
        ...
        Arreglo_<?php echo $i_padre ?>.push('<?php echo $i_general; ?>');
 		...
 		<td align="center" class="detalle"><div id="dpk<?php echo $i_general; ?>"> <?php echo $v_viajes["tarifa_ruta_pk"] ?></div></td>
                <td align="center" class="detalle"><div id="dks<?php echo $i_general; ?>"> <?php echo $v_viajes["tarifa_ruta_ks"] ?></div></td>
                <td align="center" class="detalle"><div id="dka<?php echo $i_general; ?>"> <?php echo $v_viajes["tarifa_ruta_ka"] ?></div></td>
                ...
                <td align="center"><div id="dtarifa<?php echo $i_general; ?>"><select name="tarifa<?php echo $i_general; ?>" id="tarifa<?php echo $i_general; ?>" onchange="xajax_calculos_x_tipo_tarifa(this.value,'<?php echo $v_viajes["idmaterial"]; ?>','<?php echo $i_general; ?>',document.getElementById('origen<?php echo $i_general; ?>').value,document.getElementById('tiro<?php echo $i_general; ?>').value,document.getElementById('camion<?php echo $i_general; ?>').value,0)">
...
for(o=0;o<arreglo.length;o++)
	{
		...
		try{accion=(document.getElementById('a'+arreglo[o]).checked)?1:(document.getElementById('r'+arreglo[o]).checked)?0:'n';}catch(e){accion='n'}
