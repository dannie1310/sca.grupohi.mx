...
<table width="435" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
...
<table width="840" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  ...
  <tr class="Item1">
   ...
   <tr>
    ...
    <td colspan="3" class="Item1"><?php echo $Observacion[$a]; ?>&nbsp;<input type="hidden" name="Observacion<?php echo $a; ?>" id="Observacion<?php echo $a; ?>"  value="<?php echo $Observacion[$a]; ?>"/></td>
  </tr>
  <?php
  	}
  ?>
  ...
  <tr>
     <td colspan="7" align="center"><input type="hidden" name="NumVM" id="NumVM" value="<?php echo $NumVM; ?>"/><input name="Cargar Viajes" type="submit" class="boton" id="Cargar Viajes" value="Registrar Viajes" />
    &nbsp;&nbsp;&nbsp;&nbsp;
