...
<table width="759" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr align="center">
    <td width="40">&nbsp;</td>
    <td width="30">&nbsp;</td>
    <td colspan="5" align="center" class="EncabezadoGlobal">CASILLAS PARA EL LLENADO DE LOS VIAJES</td>
    </tr>
    <tr align="center">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td width="97" class="Item2"><img src="../../../Imgs/16-Materiales.gif" width="16" height="16" /></td>
    </tr>
  <tr align="center">
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    ...
    <td class="Casillas"><select name="MaterialGeneral" id="MaterialGeneral" onchange="llena_hijos('Material','<?php echo $NumVM; ?>',document.getElementById('MaterialGeneral').value)">
      <option>- Selecciona -</option>
      <?php
					if($flag==1)
