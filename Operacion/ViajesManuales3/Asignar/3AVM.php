...
<form name="frm" method="post" action="4AVM.php" onsubmit="document.getElementById('CargarViajes').disabled=true">
<table width="840" border="1" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr>
    <td colspan="2">&nbsp;</td>
  ...
  <tr class="Item1">
    ...
    <td align="center"><?php echo $Turno[$a]; ?><input type="hidden" name="Turno<?php echo $a; ?>" id="Turno<?php echo $a; ?>" value="<?php echo $Turno[$a]; ?>"/></td>
  </tr>
   <tr>
    <td colspan="2">&nbsp;</td>
    <td>&nbsp;</td>
...
for($a=1;$a<=$NumVM;$a++)
    ...
    <input type="hidden" name="Turno<?php echo $a; ?>" id="Turno<?php echo $a; ?>"  value="<?php echo $Turno[$a]; ?>"/>
