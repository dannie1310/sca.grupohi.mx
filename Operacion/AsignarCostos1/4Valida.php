...
<form action="4Valida.php" method="post" name="frm">
 ...
 <input type="hidden" value="<?php echo $numero; ?>" name="numero">
  ...
  <tr >
    <td colspan="3" class="Subtitulo">¿SON CORRECTOS LOS DATOS DE ASIGNACIÓN DE COSTOS?</td>
    </tr>
  <tr >
    <td colspan="3">&nbsp;</td>
  </tr>
  ...
  <?PHP
   ...
   while($i<$numero) {?>
    <tr >
    <td width="182" class="Concepto">AL CENTRO DE COSTO:</td>
    <td width="408" colspan="2" class="Item1"><?php echo regresa(centroscosto,Descripcion,IdCentroCosto,$_REQUEST[centroscosto."$i"]); ?></td>
    </tr>
  <tr >
    <td class="Concepto">EN LA ETAPA DEL PROYECTO:</td>
    <td colspan="2" class="Item1"><?php  echo regresa(etapasproyectos,Descripcion,IdEtapaProyecto,$_REQUEST[etapasproyectos."$i"]); ?></td>
    </tr>
  <?PHP $i++; $pr++; }?>
...
<table width="600" border="0" align="center" >
  ...
  <tr class="Item1">
    ...
    <td align="right">&nbsp;	 </td>
	  ...
	  <form name="regresa" action="3SolicitaCentros.php" method="post">
    ...
    <td align="right" colspan="2"><input name="Submit" type="submit" class="boton" value="Regresar"></td>
	  </form>
	  ...
	  <input name="numero<?php echo $j; ?>" type="hidden" value="<?php echo $_REQUEST[numero."$j"]; ?>">
	  <?php $j++; }?>
    <td align="right"><input name="Submit" type="submit" class="boton" value="Registrar" ></td>
	</form>
   </tr>
</table>
...
<form action="4Valida.php" method="post" name="frm">
 ...
 <input type="hidden" value="<?php echo $numero; ?>" name="numero">
  ...
  <tr >
    <td width="273" class="EncabezadoTabla">CENTRO DE COSTO</td>
    <td width="188" class="EncabezadoTabla">ETAPA DE PROYECTO</td>
    <td width="125" class="EncabezadoTabla">IMPORTE</td>
  </tr>
