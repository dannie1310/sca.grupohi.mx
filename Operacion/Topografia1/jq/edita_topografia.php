...
$(function() {
		$( "#bdatepicker" ).datepicker({ dateFormat: "dd-mm-yy" });
	});
</script>
<body>
...
<table class="reporte" style="width:750px;">
    ...
    <tbody>
    	<tr>
        	<td>
            <div class="demo">
        <input id="bdatepicker" name="fecha" type="text" value="<?php echo $vsql["Fecha"];?>" style="width:100px;" class="valido" readonly="readonly">
        	</div>
        	</td>
            ...
            <td><input type="text" name="parcial" id="parcial" value="<?php echo $vsql["Parcial"];?>" class="valido edita"></td>
            <td><input type="text" name="cota" id="cota" value="<?php echo $vsql["Cota"]; ?>" class="valido edita"></td>
