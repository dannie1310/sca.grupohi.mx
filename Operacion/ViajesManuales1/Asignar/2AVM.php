...
<table width="859" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  <tr align="center">
    <td width="40">&nbsp;</td>
    <td width="30">&nbsp;</td>
  ...
  <tr class="FondoCasillas">
    ...
    <td align="center" valign="top">
    	<span id="spryNVM<?php echo $a; ?>">
      		<input onkeypress="onlyDigitsPunto(event,'decOK')" <?php if($flag==1) {?>value="<?php echo $_REQUEST["NVMS".$a]; ?>"<?php }?> class="CasillasParaFechas" align="right" name="NVM<?php echo $a; ?>" type="text" id="NVM<?php echo $a; ?>" size="2" maxlength="2"  onChange='this.value=ValidaFecha(this.value,"<?php echo date("d-m-Y"); ?>");'/>
