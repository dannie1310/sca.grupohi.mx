...
<table width="435" border="0" align="center" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
  ...
  <tr>
    <td  class="TituloDeAdvertencia">&iquest;Son correctos los datos de los viajes a registrar?</td>
  </tr>
  <tr>
...
<table width="840" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" align="center">
  ...
  <tr class="Item1">
    <td>&nbsp;<?php echo $a; ?>&nbsp;</td>
    <td style="display:none;">&nbsp;<?php echo $NVM[$a]; ?><input type="hidden" name="NVMS<?php echo $a; ?>" id="NVMS<?php echo $a; ?>" value="<?php echo $NVM[$a]; ?>"/>&nbsp;</td>
    ...
    <td>&nbsp;<?php echo $Hora[$a]; ?><input type="hidden" name="Horas<?php echo $a; ?>" id="Horas<?php echo $a; ?>" value="<?php echo $Hora[$a]; ?>"/>&nbsp;</td>
   ...
   <tr>
    ...
    <td colspan="4" class="Item1" style="font-size:11px;"><?php echo $Observacion[$a]; ?>&nbsp;<input type="hidden" name="Observacion<?php echo $a; ?>" id="Observacion<?php echo $a; ?>"  value="<?php echo $Observacion[$a]; ?>"/></td>
  </tr>
  <?php
  	}
  ?>
...
for($a=1;$a<=$NumVM;$a++)
    ...
    <input type="hidden" name="Horas<?php echo $a; ?>" id="Horas<?php echo $a; ?>" value="<?php echo $Hora[$a];?>"/>
