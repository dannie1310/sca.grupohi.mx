...
- Python 2.4 required
- Java 1.4+ required
- Yahoo JS compressor. Place it under compression_lib/yuicompressor.jar
"""
...
"""
    ...
    os.popen('java -jar compression_lib/yuicompressor.jar greybox_source/base/AJS.js > greybox/AJS.js')
    os.popen('java -jar compression_lib/yuicompressor.jar greybox_source/base/AJS_fx.js > greybox/AJS_fx.js')
    print 'Compressed AJS.js and AJS.js into greybox/'

    os.popen('java -jar compression_lib/yuicompressor.jar greybox/gb_scripts_tmp.js > greybox/gb_scripts.js')
