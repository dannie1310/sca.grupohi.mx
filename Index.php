...
if(!empty($_SESSION['IdUsuario'])) {
 ...
 WHERE (usuarios_proyectos.id_usuario_intranet = ".$_SESSION[IdUsuario]." and proyectos.status=1 ) order by  find_in_set(Descripcion,'Panel de Control') asc ";
   ...
   while ($row = $sca_config->fetch($result)) 
	...
	else $combo_sca="<select id='proyecto' onchange='define_acarreo()'><option value='null'>- Selecione una Obra -</option>$combo_sca</select>";
	}else{
                        ...
                        <body>
                            <div id="layout">
                                <table width="1000px" border="0" align="left" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr bgcolor="#000;">
                                        <td  class="Bienvenida"><div id="bienvenida"><?php echo "BIENVENIDO: " . $_SESSION['Descripcion'] . ", PROYECTO: " . $combo_sca; ?></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td id="portada_sca" valign="top" style="padding:0px"><iframe name="content" src="Portada.php" scrolling="auto" width="1000px" height="700px" frameborder="0" style="padding:0px;margin:0px"></iframe></td>
                                    </tr>
                                </table>
                            </div>
                            <script type="text/javascript">
