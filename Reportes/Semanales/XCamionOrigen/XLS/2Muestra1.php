...
<table width="1500" border="0" align="center" >
  ...
  <?php }?>
      ...
      <td colspan="2" ><table width="1500" border="0" align="center" >
        ...
        <?php
  $llena="SELECT DISTINCT v.IdCamion, c.Economico  from viajes as v, camiones as c, proyectos as p WHERE ".$consulta." c.IdCamion=v.IdCamion and v.FechaLlegada between '".fechasql($inicial)."' and '".fechasql($final)."' and p.IdProyecto=".$IdProyecto." and v.Estatus in (1,0,20,21) order by Economico;";
//echo $llena;
...
?>
        <tr>
          ...
          <td bgcolor="#969696"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px;"><?php echo $sumv2[sumaadicionales]; ?></font></div></td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
...
<table width="1500" border="0" align="center" >
 ...
 ?>
      ...
      <table width="1500" border="0" align="center" >
        ...
        <?php
    $link=SCA::getConexion();
  $llena="SELECT DISTINCT v.IdCamion, c.Economico  from viajes as v, camiones as c, proyectos as p WHERE ".$consulta." c.IdCamion=v.IdCamion and v.FechaLlegada between '".fechasql($inicial)."' and '".fechasql($final)."' and p.IdProyecto=".$IdProyecto." and c.IdSindicato=".$sindicato[$jj]." and v.Estatus in (0,1,20,21) order by Economico;";
//echo $llena;
  $r=$link->consultar($llena);
  while($d=mysql_fetch_array($r))
   {
