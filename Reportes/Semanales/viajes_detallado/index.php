...
<table width="490" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="Titulo">SCA.- Reporte de Viajes Detallado</td>
  </tr>
  <tr>
...
<table width="400" border="0" align="center" >
  <tr>
    <td width="195"  valign="top"><fieldset class="textoG" title="Consultas por Camión">
      ...
      <legend><label style="cursor:hand" onClick="if(document.getElementById('camion').value=='T') document.getElementById('radios').style.display=''; else document.getElementById('radios').style.display='none';document.getElementById('camion').disabled=false;document.getElementById('sindicato').disabled=true"><input name="tipo_consulta" type="radio" value="camion" checked id="consulta_camion">Consulta por Cami&oacute;n</label></legend>
