...
//	header('Content-Disposition:  filename=Acarreos Ejecutados por Destino '.date("d-m-Y").'_'.date("H.i.s",time()).'.xls;');
?>
...
<table width="1500" border="0" align="left" >
  ...
  <tr>
    <td colspan="4"><font color="#000000" style="font-family:'Trebuchet MS'; font-weight:bold;font-size:14px;">CONTROL DE VOLUMENES DE ACARREOS PARA CAPTURA AL SAO EN EL PER&Iacute;ODO DEL <?PHP echo $inicial; ?> AL <?PHP echo $final; ?></font></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="4"><table width="1500" border="0" align="center" >
      ...
      <tr bgcolor="#0A8FC7">
        ...
        <td bgcolor="C0C0C0"><div align="center"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold ">KM SUBSEC.</font></div></td>
        <td bgcolor="C0C0C0"><div align="center"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold ">1ER. KM </font></div></td>
        <td bgcolor="C0C0C0"><div align="center"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold ">KM SUBSEC. </font></div></td>
        <td bgcolor="C0C0C0"><div align="center"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold ">1ER. KM </font></div></td>
        <td bgcolor="C0C0C0"><div align="center"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold ">KM SUBSEC.</font> </div></td>
...
//echo $rows;
      ...
      <tr>
        ...
        <td width="114"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px;"><?php echo $fil[Vol1KM]; ?> m<sup>3</sup></font></div></td>
        <td width="120"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px;"><?php echo $fil[VolSub]; ?> m<sup>3</sup></font></div></td>
...
?>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><div align="right"> <font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv[sumavolumen]; ?> m<sup>3</sup></font></div></td>
        <td><div align="right"> <font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv[sumasubsecuentes]; ?> m<sup>3</sup></font></div></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
	...
	?>
      ...
      <tr>
        ...
        <td bgcolor="#000000"><div align="right"> <font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($volp,2,".",","); ?> m<sup>3</sup></font></div></td>
        <td bgcolor="#000000"><div align="right"> <font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($volsub,2,".",","); ?> m<sup>3</sup></font></div></td>
        <td bgcolor="#000000">&nbsp;</td>
        <td bgcolor="#000000">&nbsp;</td>
