...
if(isset($_REQUEST["v"]) && ($_REQUEST["v"]==1)){
    ...
    header('Content-Disposition:  filename=Acarreos Ejecutados por Cami�n y Turno del '.$_REQUEST["fi"].' al '.$_REQUEST["fi"].'_'.date("d-m-Y").'_'.date("H.i.s",time()).'.xls;');
 }
...
<table width="0" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center" bgcolor="#000000" style="color:#FFF"><strong>Econ&oacute;mico</strong></td>
    <td align="center" bgcolor="#000000" style="color:#FFF"><strong>Fecha</strong></td>
    <td align="center" bgcolor="#000000" style="color:#FFF"><strong>Cubicaci&oacute;n</strong></td>
