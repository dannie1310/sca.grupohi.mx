...
<table width="1500" border="0" align="center" >
 ...
 for($jj=0;$jj<sizeof($sindicatos);$jj++){
   $suma_sindicato='';

  // echo '<br> luis '.$jj . ' _ ' . $sindicatos[$jj] ;
      ?>
      <tr>
        <td colspan="2" >
            <table width="1500" border="0" align="center" >
                <tr>
                  <td colspan="11">
                      ...
                      <font color="#666666" face="Trebuchet MS" style="font-size:12px;"><?php regresa(sindicatos, NombreCorto, IdSindicato, $sindicatos[$jj]);?></font>
                  </td>
                </tr>
                <tr>
                  <td colspan="5">&nbsp;</td>
...
//$llena="SELECT DISTINCT v.IdCamion, c.Economico  from viajes as v, camiones as c, proyectos as p WHERE ".$consulta." c.IdCamion=v.IdCamion and v.FechaLlegada between '".fechasql($inicial)."' and '".fechasql($final)."' and p.IdProyecto=".$IdProyecto." and c.IdSindicato=".$sindicato[$jj]." order by Economico;";
        ...
        $llena="
          ...
          WHERE v.FechaLlegada between '".fechasql($inicial)."' and '".fechasql($final)."' 
            ...
            and v.IdSindicato=".$sindicatos[$jj]." 
          ORDER BY Economico;";
        //echo '<br>'.$llena;
