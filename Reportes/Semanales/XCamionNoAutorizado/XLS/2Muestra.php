...
?>
        <tr>
          ...
          <td><div align="center"><font color="#000000" face="Trebuchet MS" style="font-size:10px;"><?php echo $fil["Hora"]; ?></font></div></td>
          ...
          <td><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px;"><?php echo number_format($Importe,2); ?></font></div></td>
			<td colspan="2"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px;"><?php echo $fil["observaciones"]; ?></font></div></td>
       </tr>
        <?php
   $x++;
   }
...
$fsuma=mysql_fetch_array($rsuma); 
   ?>
    ...
    <tr>
        ...
        <td colspan="15" style="border:solid 1px #000000;"><div>&nbsp;</div></td>
    </tr>
    <tr>
    	<td>&nbsp;</td>
    </tr>
   <tr>
    <td>&nbsp;</td>
   	<td colspan="4" style="background-color:#555555;"><div align="center"><font color="#ffffff" face="Trebuchet MS" style="font-size:10px;">Subotal</font></div></td>
   ...
   $TotalViajes=$TotalViajes+$fsuma["NumViajes"];
    ...
    <tr>
    	<td>&nbsp;</td>
         <td colspan="4" align="center" style="background-color:#222222;"><div><font color="#ffffff" face="Trebuchet MS" style="font-size:10px;">Total</font></div></td>
...
?>
        <tr>
          ...
          <td width="88"><div align="center"><font color="#000000" face="Trebuchet MS" style="font-size:10px;"><?php echo $fil["Hora"]; ?></font></div></td>
...
?>
    ...
    <tr>
        ...
        <tr>
          ...
          <td bgcolor="222222" colspan="3"><font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold">&nbsp;</font></td>
