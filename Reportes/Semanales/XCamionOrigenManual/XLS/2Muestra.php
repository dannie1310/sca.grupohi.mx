<?php
    ...
    header('Content-Disposition:  filename=Acarreos Ejecutados por Tipo de Viaje '.date("d-m-Y").'_'.date("H.i.s",time()).'.cvs;');
?>
<html>
<head>
...
<table width="1500" border="0" align="center" >
  ...
  <?php }?>
    ...
    <!-- Tabla de Viajes Con Origen Todos los Camiones-->
      	...
      	<table width="1500" border="0" align="center" >
        <tr>
          <td colspan="19" style="color:#FFF; background-color:#000; font-weight:600;">VIAJES CON ORIGEN</td>
          <!--<td width="32">&nbsp;</td>
          <td width="60">&nbsp;</td>
          <td width="54">&nbsp;</td>
          <td width="50">&nbsp;</td>
        ...
        <?php
  $llena="SELECT DISTINCT v.IdCamion, c.Economico  from viajes as v, camiones as c, proyectos as p WHERE ".$consulta." c.IdCamion=v.IdCamion and v.FechaLlegada between '".fechasql($inicial)."' and '".fechasql($final)."' and p.IdProyecto=".$IdProyecto." and v.Estatus in (1,0) order by Economico;";
//echo $llena;
...
?>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td bgcolor="#000000"><div align="center"><font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold">SUBTOTAL:</font></div></td>
...
?>
    ...
    <!-- Tabla de Viajes Manuales Todos los Camiones-->
        ...
        <table width="1500" border="0" align="center" >
        <tr>
          <td colspan="19" style="color:#FFF; background-color:#000; font-weight:600;">VIAJES REGISTRADOS DE FORMA MANUAL</td>
          <!--<td width="32">&nbsp;</td>
          <td width="60">&nbsp;</td>
          <td width="54">&nbsp;</td>
          <td width="50">&nbsp;</td>
        ...
        <?php
  $llena="SELECT DISTINCT v.IdCamion, c.Economico  from viajes as v, camiones as c, proyectos as p WHERE ".$consulta." c.IdCamion=v.IdCamion and v.FechaLlegada between '".fechasql($inicial)."' and '".fechasql($final)."' and p.IdProyecto=".$IdProyecto." and v.Estatus in (20,21) order by Economico;";
//echo $llena;
  $r=$link->consultar($llena);
  while($d=mysql_fetch_array($r))
   {
...
?>
   ...
   $x++;
    ...
    $sum3="SELECT SUM(VolAdic) as sumaadicionales, SUM(NumViajes) as sumaviajes, SUM(Vol1KM) as sumavolumen,SUM(VolSub) as sumasubsecuentes, SUM(Imp1Km) as sumaimporte, SUM(ImpSub) as sumasub, SUM(ImpAdc) as sumaadc, SUM(Importe) as sumatotal 
FROM (SELECT 
...
$voladc3=$voladc3+$sumv3["sumaadicionales"];
$impp3=$impp3+$sumv3["sumaimporte"];
$impsub3=$impsub3+$sumv3["sumasub"];
$impadc3=$impadc3+$sumv3["sumaadc"];

$imp3=$imp3+($sumv3["sumaimporte"]+$sumv3["sumasub"]+$sumv3["sumaadc"]); 
?>
        <tr>
          <td><font color="#0099CC" face="Trebuchet MS" style="font-size:10px; font-weight:bold"></font></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td bgcolor="#969696"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold">SUBTOTAL CAMI&Oacute;N:</font></div></td>
          <td bgcolor="#969696"><div align="right"> <font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumaviajes]; ?></font></div></td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696"><div align="right"> <font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumavolumen]; ?></font></div></td>
          <td bgcolor="#969696"><div align="right"> <font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumasubsecuentes]; ?></font></div></td>
          <td bgcolor="#969696"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px;"><?php echo $sumv3[sumaadicionales]; ?></font></div></td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumaimporte]; ?></font></div></td>
          <td bgcolor="#969696"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumasub]; ?></font></div></td>
          <td bgcolor="#969696"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumaadc]; ?></font></div></td>
          <td bgcolor="#969696"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php  echo number_format($sumv3[sumaimporte]+$sumv3[sumasub]+$sumv3[sumaadc],2,".",","); ?>
          </font></div></td>
        </tr>
        <tr>
          <td colspan="5">&nbsp;</td>
        ...
        <tr>
          ...
          <td>&nbsp;</td>
          <td bgcolor="#000000"><div align="center"><font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold">SUBTOTAL:</font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumtot3; ?></font></div></td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($volp3,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($volsub3,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($voladc3,2,".",","); ?></font></div></td>
          <td bgcolor="#000000">&nbsp;</td>
          <td colspan="2" bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($impp3,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($impsub3,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($impadc3,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($imp3,2,".",","); ?></font></div></td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
...
?>
   ...
   $x++;
    ...
    $sum_tot="SELECT SUM(VolAdic) as sumaadicionales, SUM(NumViajes) as sumaviajes, SUM(Vol1KM) as sumavolumen,SUM(VolSub) as sumasubsecuentes, SUM(Imp1Km) as sumaimporte, SUM(ImpSub) as sumasub, SUM(ImpAdc) as sumaadc, SUM(Importe) as sumatotal 
FROM (SELECT 
...
".$consulta."
 ...
 group by Material,Banco,Tiro) 
  AS Registros";
//echo $sum_tot;
$suma_tot=$link->consultar($sum_tot);
$sumv_tot=mysql_fetch_array($suma_tot);
$sumtot_tot=$sumtot_tot+$sumv_tot["sumaviajes"];
$volp_tot=$volp_tot+$sumv_tot["sumavolumen"];
$volsub_tot=$volsub_tot+$sumv_tot["sumasubsecuentes"];
$voladc_tot=$voladc_tot+$sumv_tot["sumaadicionales"];
$impp_tot=$impp_tot+$sumv_tot["sumaimporte"];
$impsub_tot=$impsub_tot+$sumv_tot["sumasub"];
$impadc_tot=$impadc_tot+$sumv_tot["sumaadc"];

$imp_tot=$imp_tot+($sumv_tot["sumaimporte"]+$sumv_tot["sumasub"]+$sumv_tot["sumaadc"]); 
?>
        ...
        <tr>
          ...
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumtot_tot; ?></font></div></td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($volp_tot,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($volsub_tot,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($voladc_tot,2,".",","); ?></font></div></td>
          <td bgcolor="#000000">&nbsp;</td>
          <td colspan="2" bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($impp_tot,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($impsub_tot,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($impadc_tot,2,".",","); ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($imp_tot,2,".",","); ?></font></div></td>
        </tr>
      </table>
        </td>
    </tr>
...
<table width="1500" border="0" align="center" >
  ...
  <tr>
    ...
    <table width="1500" border="0" align="center" >
        ...
        <tr>
          <td colspan="16" style="color:#FFF; background-color:#000; font-weight:600;">VIAJES CON ORIGEN</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
...
?>
        <tr>
          ...
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td bgcolor="#000000"><div align="right"><font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold">SUBTOTAL:</font></div></td>
...
?>
  ...
  <tr>
    ...
    <table width="1500" border="0" align="center" >
        ...
        <tr>
          <td colspan="16" style="color:#FFF; background-color:#000; font-weight:600;">VIAJES REGISTRADOS DE FORMA MANUAL</td>
        </tr>
        <tr>
        	<td>&nbsp;</td>
        </tr>
...
?>
        <tr>
          ...
          <td>&nbsp;</td>
          <td bgcolor="#000000"><div align="right"><font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold">SUBTOTAL:</font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumaviajes]; ?></font></div></td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000"><div align="right"> <font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumavolumen]; ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumasubsecuentes]; ?></font></div></td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000"><div align="right"><font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumaimporte]; ?></font></div></td>
          <td bgcolor="#000000"><div align="right"><font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv3[sumasub]; ?></font></div></td>
          <td bgcolor="#000000"><div align="right"><font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php  echo number_format($sumv3[sumaimporte]+$sumv2[sumasub],2,".",","); ?>
          </font></div></td>
        </tr>
        <tr>
          <td colspan="5">&nbsp;</td>
...
?>
 ...
 $sum_tot="SELECT SUM(NumViajes) as sumaviajes, SUM(Vol1KM) as sumavolumen,SUM(VolSub) as sumasubsecuentes, SUM(Imp1Km) as sumaimporte, SUM(ImpSub) as sumasub, SUM(Importe) as sumatotal 
FROM (SELECT 
		 c.Economico as Economico, 
		 v.FechaLlegada as Fecha, 
		 c.CubicacionParaPago as Cubicacion, 
...
?>
        <tr>
          ...
          <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv_tot[sumaviajes]; ?></font></div></td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000"><div align="right"> <font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv_tot[sumavolumen]; ?></font></div></td>
          <td bgcolor="#000000"><div align="right"> <font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv_tot[sumasubsecuentes]; ?></font></div></td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000">&nbsp;</td>
          <td bgcolor="#000000"><div align="right"><font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv_tot[sumaimporte]; ?></font></div></td>
          <td bgcolor="#000000"><div align="right"><font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv_tot[sumasub]; ?></font></div></td>
          <td bgcolor="#000000"><div align="right"><font color="#FFFFFF" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php  echo number_format($sumv_tot[sumaimporte]+$sumv_tot[sumasub],2,".",","); ?>
          </font></div></td>
        </tr>
        <tr>
          <td colspan="5">&nbsp;</td>
 ...
 ?>
	...
	<tr>
      <td colspan="2" >
        ...
        <?php
		$link=SCA::getConexion();
  $llena="SELECT DISTINCT v.IdCamion, c.Economico  from viajes as v, camiones as c, proyectos as p WHERE ".$consulta." c.IdCamion=v.IdCamion and v.FechaLlegada between '".fechasql($inicial)."' and '".fechasql($final)."' and p.IdProyecto=".$IdProyecto." and c.IdSindicato=".$sindicato[$jj]." and v.Estatus in (0,1) order by Economico;";
//echo $llena;
  $r=$link->consultar($llena);
  while($d=mysql_fetch_array($r))
   {
...
?>
    ...
    <tr>
        ...
        <?php
		$link=SCA::getConexion();
  $llena="SELECT DISTINCT v.IdCamion, c.Economico  from viajes as v, camiones as c, proyectos as p WHERE ".$consulta." c.IdCamion=v.IdCamion and v.FechaLlegada between '".fechasql($inicial)."' and '".fechasql($final)."' and p.IdProyecto=".$IdProyecto." and c.IdSindicato=".$sindicato[$jj]." and v.Estatus in (20,21) order by Economico;";
//echo $llena;
  $r=$link->consultar($llena);
  while($d=mysql_fetch_array($r))
   {
...
?>
   ...
   $x++;
    ...
    $sum4="SELECT SUM(NumViajes) as sumaviajes, SUM(Vol1KM) as sumavolumen,SUM(VolSub) as sumasubsecuentes, SUM(Imp1Km) as sumaimporte, SUM(ImpSub) as sumasub, SUM(Importe) as sumatotal 
FROM (SELECT 
...
".$consulta."
 ...
 group by Material,Banco,Tiro) 
  AS Registros";
//echo $sum;
$suma4=$link->consultar($sum4);
$sumv4=mysql_fetch_array($suma4);
$sumtot4=$sumtot4+$sumv4["sumaviajes"];
$volp4=$volp4+$sumv4["sumavolumen"];
$volsub4=$volsub4+$sumv4["sumasubsecuentes"];
$impp4=$impp4+$sumv4["sumaimporte"];
$impsub4=$impsub4+$sumv4["sumasub"];

$imp4=$imp4+($sumv4["sumaimporte"]+$sumv4["sumasub"]); 
?>
        <tr>
          <td><font color="#0099CC" face="Trebuchet MS" style="font-size:10px; font-weight:bold"></font></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td bgcolor="#CCCCCC"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold">SUBTOTAL CAMI&Oacute;N:</font></div></td>
          <td bgcolor="#CCCCCC"><div align="right"> <font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv4[sumaviajes]; $suma_sindicato4["viajes"]=$suma_sindicato4["viajes"]+$sumv4[sumaviajes];?></font></div></td>
          <td bgcolor="#CCCCCC">&nbsp;</td>
          <td bgcolor="#CCCCCC">&nbsp;</td>
          <td bgcolor="#CCCCCC">&nbsp;</td>
          <td bgcolor="#CCCCCC">&nbsp;</td>
          <td bgcolor="#CCCCCC"><div align="right"> <font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv4[sumavolumen]; $suma_sindicato4["volumen"]=$suma_sindicato4["volumen"]+$sumv4[sumavolumen];?></font></div></td>
          <td bgcolor="#CCCCCC"><div align="right"> <font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv4[sumasubsecuentes]; $suma_sindicato4["volumen_sub"]=$suma_sindicato4["volumen_sub"]+$sumv4[sumasubsecuentes];?></font></div></td>
          <td bgcolor="#CCCCCC">&nbsp;</td>
          <td bgcolor="#CCCCCC">&nbsp;</td>
          <td bgcolor="#CCCCCC"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv4[sumaimporte]; $suma_sindicato4["importe"]=$suma_sindicato4["importe"]+$sumv4[sumaimporte]; ?></font></div></td>
          <td bgcolor="#CCCCCC"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumv4[sumasub]; $suma_sindicato4["importe_sub"]=$suma_sindicato4["importe_sub"]+$sumv4[sumasub]; ?></font></div></td>
          <td bgcolor="#CCCCCC"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php  echo number_format($sumv4[sumaimporte]+$sumv4[sumasub],2,".",","); $suma_sindicato4["importe_tot"]=$suma_sindicato4["importe_tot"]+$sumv4[sumaimporte]+$sumv4[sumasub]; ?>
          </font></div></td>
        </tr>
    ...
    <tr>
          ...
          <td>&nbsp;</td>
          <td bgcolor="#969696"><div align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold">SUBTOTAL SINDICATO:</font></div></td>
          <td align="right" bgcolor="#969696"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $suma_sindicato4["viajes"]; ?></font></td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696" align="right"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($suma_sindicato4["volumen"],2,".",""); ?></font></td>
          <td align="right" bgcolor="#969696"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($suma_sindicato4["volumen_sub"],2,".",""); ?></font></td>
          <td bgcolor="#969696">&nbsp;</td>
          <td bgcolor="#969696">&nbsp;</td>
          <td align="right" bgcolor="#969696"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($suma_sindicato4["importe"],2,".",""); ?></font></td>
          <td align="right" bgcolor="#969696"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($suma_sindicato4["importe_sub"],2,".",""); ?></font></td>
          <td align="right" bgcolor="#969696"><font color="#000000" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo number_format($suma_sindicato4["importe_tot"],2,".",""); ?></font></td>
        </tr>
    ...
    <tr>
        ...
        <?php
		$link=SCA::getConexion();
  $llena_3="SELECT DISTINCT v.IdCamion, c.Economico  from viajes as v, camiones as c, proyectos as p WHERE ".$consulta." c.IdCamion=v.IdCamion and v.FechaLlegada between '".fechasql($inicial)."' and '".fechasql($final)."' and p.IdProyecto=".$IdProyecto." and c.IdSindicato=".$sindicato[$jj]." order by Economico;";
//echo $llena_3;
