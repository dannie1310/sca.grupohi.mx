...
<table width="490" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td class="Titulo">SCA.- Reporte de Movimiento de Tierra por Cami&oacute;n m&aacute;s el Centro Costo</td>
  </tr>
  <tr>
...
<table width="400" border="0" align="center" >
  <tr>
    <td width="195"  valign="top"><fieldset class="textoG" title="Consultas por Cami�n">
      
      <legend><label style="cursor:hand" onClick="if(document.getElementById('camion').value=='T') document.getElementById('radios').style.display=''; else document.getElementById('radios').style.display='none';document.getElementById('camion').disabled=false;document.getElementById('sindicato').disabled=true"><input name="tipo_consulta" type="radio" value="camion" checked id="consulta_camion">Consulta por Cami�n</label></legend>
...
from viajes as v join sindicatos as s using(IdSindicato) where v.IdProyecto=".$IdProyecto."";
	...
	$size=5;
      ...
      <table>
        ...
        <tr>
          <td><select name="sindicato[]" size="<?php echo $size ?>" multiple id="sindicato" disabled>
            <?php while($v=mysql_fetch_array($r))
		{?>
