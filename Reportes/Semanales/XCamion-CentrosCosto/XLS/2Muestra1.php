            ...
            /*   $rows="
              SELECT 
                 ...
                 c.CubicacionParaPago,
                  ...
                  fn_devuelve_tarifa(TipoTarifa,IdTarifa,'a_km') as 'PUAdc'     FROM  viajes v, proyectos p, sindicatos s, camiones c, origenes o, tiros t, materiales m
            WHERE
            ".$consulta." c.IdCamion=".$d[IdCamion]." and  v.FechaLlegada between '".fechasql($inicial)."' and  '".fechasql($final)."' and  p.IdProyecto=".$IdProyecto." and  v.IdProyecto = p.IdProyecto and  v.idCamion=c.idCamion and c.idSindicato=s.IdSindicato and 
             v.IdOrigen=o.IdOrigen and v.IdTiro=t.IdTiro and v.IdMaterial=m.IdMaterial  group by Fecha, Cubicacion,Material,Banco,Tiro,TipoTarifa,IdTarifa
             Order by Fecha";//echo $rows;*/
             $rows="SELECT  
              sum(v.peso) as peso,
              c.Economico as Economico, 
              v.FechaLlegada as Fecha, 
...
?>
    ...
    <tr>
                ...
                <td >
                 <td bgcolor="#000000">
                    <div align="right"><font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold">TOTAL:</font></div>
                </td>
           <td bgcolor="#000000"><div align="right"> <font color="#ffffff" face="Trebuchet MS" style="font-size:10px; font-weight:bold"><?php echo $sumtot; ?></font></div></td>
                        <td bgcolor="#000000">&nbsp;</td>
                        <td bgcolor="#000000">&nbsp;</td>
