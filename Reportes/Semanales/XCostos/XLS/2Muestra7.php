...
#####################################################     NIVEL 1      ######################################################
	...
	$sql1="SELECT distinct substr(Nivel,1,4) as Nivel1 FROM centroscosto centroscosto INNER JOIN costos costos ON (centroscosto.IdCentroCosto = costos.IdCentroCosto and $comp centroscosto.IdProyecto=".$_SESSION[Proyecto].")";
...
############################################################         NIVEL 2        ##########################################
		...
		$sql2 = "SELECT distinct substr(Nivel,1,8) as Nivel2 FROM centroscosto centroscosto INNER JOIN costos costos ON (centroscosto.IdCentroCosto = costos.IdCentroCosto) where Nivel LIKE '".$vsql1["Nivel1"]."%';";
...
#############################################################   NIVEL 3      #######################################################
			...
			$sql3 = "SELECT distinct substr(Nivel,1,12) as Nivel3 FROM centroscosto centroscosto INNER JOIN costos costos ON (centroscosto.IdCentroCosto = costos.IdCentroCosto) where Nivel LIKE '".$vsql2["Nivel2"]."%';";
...
####################################################    NIVEL 4    #############################################################################
				...
				$sql4 = "SELECT distinct substr(Nivel,1,16) as Nivel4 FROM centroscosto centroscosto INNER JOIN costos costos ON (centroscosto.IdCentroCosto = costos.IdCentroCosto) where Nivel LIKE '".$vsql3["Nivel3"]."%';";
...
###############################################################         NIVEL 5      ##############################################################################################
							...
							$sql5 = "SELECT distinct substr(Nivel,1,20) as Nivel5  FROM centroscosto centroscosto INNER JOIN costos costos ON (centroscosto.IdCentroCosto = costos.IdCentroCosto) where Nivel LIKE '".$vsql4["Nivel4"]."%';";
            ...
            <td align="left" bordercolor="#000000" bgcolor="#FFFFFF" style="border-right-width:1px"><font color="#000000" face="Calibri" style="font-size:12px; font-weight:bold ">
			<?php echo $link->regresaDatos2("centroscosto","Cuenta","Nive5",$vsql1["Nivel5"]); ?></font>
            </td>
             <?php
