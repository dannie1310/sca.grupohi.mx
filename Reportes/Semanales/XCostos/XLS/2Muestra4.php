...
<table border="1" cellspacing="0" >
  ...
  <tr>
    <td colspan="22" style="border-color:#FFF" align="center"><font color="#000000" style="font-family:'Trebuchet MS'; font-weight:bold;font-size:14px;">CONCENTRADO DE ACARREOS POR CENTRO DE COSTO DEL <?PHP echo $inicial; ?> AL <?PHP echo $final; ?></font></td>
  </tr>
...
<tr>
  ...
  <tr>
	...
	<?php
	$SQL1 = "select concat(repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',length(Nivel)/4),Descripcion) as Costo from centroscosto where IdPadre=0";
	$RSQL1 = $link->consultar($SQL1);
	$VSQL1 = $link->fetch($RSQL1);
	?>
	<tr>
		<td align="left" bordercolor="#000000" bgcolor="#FFFFFF" style="border-right-width:1px" ><font color="#000000" face="Calibri" style="font-size:12px; font-weight:bold "><?php echo $VSQL1["Costo"]?></font></td>
		<td align="left" bordercolor="#000000" bgcolor="#FFFFFF" style="border-right-width:1px" ><font color="#000000" face="Calibri" style="font-size:12px; font-weight:bold ">&nbsp;</font></td>
		<td align="center" bordercolor="#000000" bgcolor="#FFFFFF"  ><font color="#000000" face="Calibri" style="font-size:12px;">&nbsp;</font></td>
		<td align="center" bordercolor="#000000" bgcolor="#FFFFFF"  ><font color="#000000" face="Calibri" style="font-size:12px;">&nbsp;</font></td>
		<td align="center" bordercolor="#000000" bgcolor="#FFFFFF"  ><font color="#000000" face="Calibri" style="font-size:12px;">&nbsp;</font></td>
		<td align="center" bordercolor="#000000" bgcolor="#FFFFFF" style="border-right-width:1px" ><font color="#000000" face="Calibri" style="font-size:12px;">&nbsp;</font></td>
		<td align="center" bordercolor="#000000" bgcolor="#FFFFFF"  ><font color="#000000" face="Calibri" style="font-size:12px;">&nbsp;</font></td>
		<td align="center" bordercolor="#000000" bgcolor="#FFFFFF"  ><font color="#000000" face="Calibri" style="font-size:12px;">&nbsp;</font></td>
		<td align="center" bordercolor="#000000" bgcolor="#FFFFFF" style="border-right-width:1px" ><font color="#000000" face="Calibri" style="font-size:12px;">&nbsp;</font></td>
		<td align="center" bordercolor="#000000" bgcolor="#FFFFFF"  ><font color="#000000" face="Calibri" style="font-size:12px;">&nbsp;</font></td>
...
//echo $SQL2;
		...
		while($VSQL2 = $link->fetch($RSQL2)){
			...
			//NIVEL1********************************************************************************************************************************
			$SQL3 = "select distinct(IdCentroCosto),Cuenta,concat(repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',length(Nivel)/4),Descripcion) as Costo,IdPadre from centroscosto where IdCentroCosto = '".$VSQL2["IdPadre"]."'";
    ...
    <td align="center" bordercolor="#000000" bgcolor="#666666"  ><font color="#ffffff" face="Calibri" style="font-size:12px;">$&nbsp;<?php echo number_format($v_af[IT],2,'.','') ?></font></td>
                ...
                <?php
				//NIVEL2********************************************************************************************************************************
				$SQL4 = "select distinct(IdCentroCosto),Cuenta,concat(repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',length(Nivel)/4),Descripcion) as Costo from centroscosto where IdCentroCosto in (select distinct(IdCentroCosto) from costos) AND IdPadre = '".$VSQL3["IdCentroCosto"]."'";				
$RSQL4 = $link->consultar($SQL4);
    ...
    <td align="center" bordercolor="#000000" bgcolor="#666666"  ><font color="#ffffff" face="Calibri" style="font-size:12px;">$&nbsp;<?php echo number_format($v_af[IT],2,'.','') ?></font></td>
                	...
                	<?php
					//NIVEL3********************************************************************************************************************************
					$SQL5 = "select distinct(IdCentroCosto),Cuenta,concat(repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',length(Nivel)/4),Descripcion) as Costo from centroscosto where IdCentroCosto in (select distinct(IdCentroCosto) from costos) AND IdPadre = '".$VSQL4["IdCentroCosto"]."'";
    ...
    <td align="center" bordercolor="#000000" bgcolor="#666666"  ><font color="#ffffff" face="Calibri" style="font-size:12px;">$&nbsp;<?php echo number_format($v_af[IT],2,'.','') ?></font></td>
                        ...
                        <?php
						//NIVEL4********************************************************************************************************************************
						$SQL6 = "select distinct(IdCentroCosto),Cuenta,concat(repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',length(Nivel)/4),Descripcion) as Costo from centroscosto where IdCentroCosto in (select disctinct(IdCentroCosto) from costos) AND IdPadre = '".$VSQL5["IdCentroCosto"]."'";
    ...
    <td align="center" bordercolor="#000000" bgcolor="#666666"  ><font color="#ffffff" face="Calibri" style="font-size:12px;">$&nbsp;<?php echo number_format($v_af[IT],2,'.','') ?></font></td>
                            ...
                            <?php
							//NIVEL5********************************************************************************************************************************
							$SQL7 = "select distinct(IdCentroCosto),Cuenta,concat(repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',length(Nivel)/4),Descripcion) as Costo from centroscosto where IdCentroCosto in (select distinct(IdCentroCosto) from costos) AND IdPadre = '".$VSQL6["IdCentroCosto"]."'";
    ...
    <td align="center" bordercolor="#000000" bgcolor="#666666"  ><font color="#ffffff" face="Calibri" style="font-size:12px;">$&nbsp;<?php echo number_format($v_af[IT],2,'.','') ?></font></td>
                                ...
                                <?php
								//NIVEL6********************************************************************************************************************************
								$SQL8 = "select distinct(IdCentroCosto),Cuenta,concat(repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',length(Nivel)/4),Descripcion) as Costo from centroscosto where IdCentroCosto in (select distinct(IdCentroCosto) from costos) AND IdPadre = '".$VSQL7["IdCentroCosto"]."'";
    ...
    <td align="center" bordercolor="#000000" bgcolor="#666666"  ><font color="#ffffff" face="Calibri" style="font-size:12px;">$&nbsp;<?php echo number_format($v_af[IT],2,'.','') ?></font></td>
                                    ...
                                    <?php
									//NIVEL7********************************************************************************************************************************
									$SQL9 = "select distinct(IdCentroCosto),Cuenta,concat(repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',length(Nivel)/4),Descripcion) as Costo from centroscosto where IdCentroCosto in (select disctinct(IdCentroCosto) from costos) AND IdPadre = '".$VSQL8["IdCentroCosto"]."'";
