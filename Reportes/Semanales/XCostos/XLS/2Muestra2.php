<?php
	...
	$sql = "SELECT centroscosto.IdCentroCosto,concat(repeat('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',length(Nivel)/4),centroscosto.Descripcion) as Costo, centroscosto.Cuenta, if(costos.ImporteTotal is null,'0.00',costos.ImporteTotal)
  FROM    scaatlacomulco_xii.centroscosto centroscosto
       LEFT OUTER JOIN
          scaatlacomulco_xii.costos costos
       ON (centroscosto.IdCentroCosto = costos.IdCentroCosto and $comp centroscosto.IdProyecto=".$_SESSION[Proyecto].")
	  ";
