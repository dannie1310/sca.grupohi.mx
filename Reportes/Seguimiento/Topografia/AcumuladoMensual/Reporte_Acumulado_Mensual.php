...
<tr style="color:#000; font-weight:bold; font-size:16px;">
    ...
    <td colspan="6" align="center">PROYECTO "<?php echo $SCA->regresaDatos2('proyectos','Descripcion','Estatus', 1)?>" <br> Rendimiento Acumulado Mensual de Colocaci&oacute;n <br /><font style="font-size:9px; font-weight:normal;">(<?php echo date("d-m-Y").'_'.date("H.i.s");?>)</font></td>
</tr>
<tr><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td></tr>
...
<tr><td>&nbsp;</td></tr>
<tr><td align="right" style="font-weight:bold; background-color:#03F; color:#FFF; "><i>Fecha de Inicio Real:</td></tr>
<tr><td align="right" style="font-weight:bold; background-color:#03F; color:#FFF; "><i>Fecha de Termino Segun Proy Actual:</td></tr>
<tr><td align="right" style="font-weight:bold; background-color:#F00; color:#FFF; "><i>Fecha de Corte:</i></td><td><?php echo $_REQUEST['final'];?></td></tr>
<tr><td>&nbsp;</td></tr>
</table>
<table width="400">
<tr style="background-color:#FFF; color:#FFF; font-weight:bold;">
	<td style="background-color:#333;">Conceptos</td>
<?php
...
?>
    ...
    <td style="background-color:#03F; color:#FFF; font-weight:bold;" align="center">Dias H�biles <br />Faltantes</td>
    ...
    <td style="background-color:#03F; color:#FFF; font-weight:bold;" align="center">Aceleraci�n de Rendimiento <br />Respecto a lo contratado</td>
</tr>
<?php
...
<tr><td>&nbsp;</td></tr>
<tr>
	<td style="background-color:#03F; color:#FFF; font-weight:bold;">Total General</td>
    <?php
	...
	while($vsql3 = $SCA->fetch($rsql3)){
		?>
        <td style="background-color:#03F; color:#FFF; font-weight:bold;" align="right"><?php echo $vsql3['SumaMensual']; ?></td>
        <?php
		}
	?>
    <td style="background-color:#FFF;">&nbsp;</td>
...
<tr style="background-color:#03F; color:#FFF; font-weight:bold;">
...
<tr>
	<td style="background-color:#03F; color:#FFF; font-weight:bold;">Rendimiento Por Dias Efectivos Total</td>
    <?php
	...
	while($vsql3 = $SCA->fetch($rsql3)){
		?>
        <td style="background-color:#03F; color:#FFF; font-weight:bold;" align="right"><?php echo $vsql3['Rendimiento']; ?></td>
        <?php
		}
	?>
    <td>&nbsp;</td>
