...
<table width="500" align="center" class="reporte">
    ...
    <tr>
        ...
        <td><input style="width:100px;" name="final" type="text" id="FechaFinal"  readonly value="<?php if ($seg!=1)echo date("d-m-Y"); else if($seg=1)echo $ffin2; ?>"  /><img src="../../../../Imgs/calendarp.gif" width="19" height="21" id="boton2" style="cursor:hand" /></td>
