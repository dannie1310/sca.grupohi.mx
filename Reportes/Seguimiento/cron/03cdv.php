...
$(".descargar").live("click",function(){
	
	//alert("Descargar");
	
	fecha = $("#fecha").val();
	ruta = $("#ruta").val();
	datos = "fecha="+fecha+"&ruta="+ruta+"&value=1";
	//alert(datos);
	ruta='04Result.php?'+datos;/*ruta='2Muestra.php?v=0&inicial='+fechainicial+'&final='+fechafinal+'&tipo_consulta='+tipo_consulta+'&camion='+camion+'&sindicato='+sindicato+'+&estatus='+estatus;*/
	//alert(ruta);
	window.open(ruta);
...
<div id="buscador">
	<table align="center">
    	<tr>
    <td colspan="3"><span class="EncabezadoPagina">Consulta Tiempo de Recorrido por Viaje y Cami&oacute;n</span></td>
  </tr>
  <tr>
...
?>
        	...
        	<td>
            	<input type="button" onclick="busca('fecha','ruta')" value="Vista Previa" />
                <input type="button" class="descargar" value="Descargar Excel" />
            </td>
        </tr>
    </table>
</div>
