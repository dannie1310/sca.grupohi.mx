...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" background="Imgs/banner.jpg" style="width:1000px; height:60px;"><br />
        <br />
        <!--<label class="style1">GLN.- Sistema de Control de Acarreos</label>-->    </td>
  </tr>
  <tr bgcolor="#000">
  ...
  <tr>
    <td colspan="2"><div align="right">V23042012</div></td> 
  </tr>
</table>
...
<table width="995" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="11">&nbsp;</td>
    <td width="120">&nbsp;</td>
    <td width="821" colspan="2"><br /><br /><br /><img src="Imgs/sca_one_page.jpg" width="411" height="182"/></td>
    </tr>
</table>
<div id="apDiv1" style="position:absolute; margin-top:-100px; margin-left:-25px;">
  <form name="frm" method="post" action="Chk.php">
    <table border="0" cellspacing="0" cellpadding="0" align="center">
      <tr>
        <td><span class="style4">Usuario:</span></td>
      </tr>
      <tr>
        <td colspan="2"><label><span class="FondoCasillas">
      ...
      <tr>
        <td><span class="style4">Contraseña:</span></td>
       </tr>
       <tr>
        <td colspan="2"><label><span class="FondoCasillas">
      ...
      <tr>
      	<td align="center"><input type="submit" value="Ingresar" "/></td><!-- onclick="document.frm.submit() -->	
        <td align="center"><input type="button" value="Borrar" onclick="document.frm.reset()"/></td>
      </tr>
    </table>
  </form>
</div>
